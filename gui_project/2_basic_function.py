...
def add_file():
    files = filedialog.askopenfilenames(title="Select image(s)", \
        ...
        initialdir='C:/Users/iriskim/Code/pygameworkspace/pygame_project/images') # the very first location
...
def browse_dest_path():
    ...
    if folder_selected is None: # if user cancels action
        return
